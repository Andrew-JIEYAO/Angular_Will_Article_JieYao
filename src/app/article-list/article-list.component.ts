...
export class ArticleListComponent implements OnInit {
  ...
  onChangeTitle($event: any) {
    this.items = this.items.map((v: any) => {
      if(v.id == $event.id) {
        return Object.assign({}, v, $event);
      };
      return v;
    });
  };
    ...
    this.items = [
      {
        ...
        categoryLink: 'http://blog.miniasp.com/category/Visual-Studio.aspx',
        summary:
      ...
      },
      {
        ...
        categoryLink: 'http://blog.miniasp.com/category/ASPNET-MVC.aspx',
        summary:
